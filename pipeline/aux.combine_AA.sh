...
./pipeline/combine_multiseq_aln.py  --moltype PROT -p combined_top50.partition --expected Top50.expected_prefixes.lst  --ext $EXT -d $INDIR -o phyling_align_top50/Top50_multi.mfa
